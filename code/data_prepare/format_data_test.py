...
round2_vid_path = os.path.join(round2_root, "video_test")

round2_folders = [round2_root, round2_vid_path]
create_folders(round2_folders)

# move round 2 video data
round2_vid = ["../../tcdata/panda_round2_test_20210331_A_part{:}".format(x) for x in range(1, 4)]
copy_folders(round2_vid, round2_vid_path)
